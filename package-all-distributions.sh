...
NXP_SNAPSHOT=${NXP_SNAPSHOT:-5.4.1-SNAPSHOT}
NXP_TAG=${NXP_TAG:-5.4.1$TAG}
NXP_NEXT_SNAPSHOT=${NXP_NEXT_SNAPSHOT:-5.4.1-SNAPSHOT}

NXC_BRANCH=${NXC_BRANCH:-5.4}
NXC_SNAPSHOT=${NXC_SNAPSHOT:-5.4.1-SNAPSHOT}
NXC_TAG=${NXC_TAG:-5.4.1$TAG}
NXC_NEXT_SNAPSHOT=${NXC_NEXT_SNAPSHOT:-5.4.1-SNAPSHOT}

# Addons
NXA_BRANCH=${NXA_BRANCH:-5.4}
NXA_SNAPSHOT=${NXA_SNAPSHOT:-5.4.1-SNAPSHOT}
NXA_TAG=${NXA_TAG:-5.4.1$TAG}
