...
NXP_BRANCH=5.3
NXP_SNAPSHOT=5.3.1-SNAPSHOT
NXP_TAG=5.3.1$TAG
NXP_NEXT_SNAPSHOT=5.3.1-SNAPSHOT

NXC_BRANCH=1.6
NXC_SNAPSHOT=1.6.1-SNAPSHOT
NXC_TAG=1.6.1$TAG
NXC_NEXT_SNAPSHOT=1.6.1-SNAPSHOT

# Addons
NXA_BRANCH=5.3
NXA_SNAPSHOT=5.3.1-SNAPSHOT
NXA_TAG=5.3.1$TAG
NXA_NEXT_SNAPSHOT=5.3.1-SNAPSHOT
