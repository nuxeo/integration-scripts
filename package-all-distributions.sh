...
NXP_SNAPSHOT=${NXP_SNAPSHOT:-5.3.2-SNAPSHOT}
NXP_TAG=${NXP_TAG:-5.3.2}$TAG
NXP_NEXT_SNAPSHOT=${NXP_NEXT_SNAPSHOT:-5.3.2-SNAPSHOT}

NXC_BRANCH=${NXC_BRANCH:-1.6}
NXC_SNAPSHOT=${NXC_SNAPSHOT:-1.6.2-SNAPSHOT}
NXC_TAG=${NXC_TAG:-1.6.2}$TAG
NXC_NEXT_SNAPSHOT=${NXC_NEXT_SNAPSHOT:-1.6.2-SNAPSHOT}

# Addons
NXA_BRANCH=${NXA_BRANCH:-5.3}
NXA_SNAPSHOT=${NXA_SNAPSHOT:-5.3.2-SNAPSHOT}
NXA_TAG=${NXA_TAG:-5.3.2}$TAG
NXA_NEXT_SNAPSHOT=${NXA_NEXT_SNAPSHOT:-5.3.2-SNAPSHOT}
