...
# Run selenium tests
SUITES="suite1 suite2 suite-dm suite-webengine suite-webengine-website" HIDE_FF=true URL=http://127.0.1.2:8080/nuxeo/ "$NXDISTRIBUTION"/nuxeo-distribution-dm/ftest/selenium/run.sh
ret1=$?
