...
./scripts/release_mp.py clone -m https://raw.githubusercontent.com/nuxeo/integration-scripts/fix-NXP-20105-release-marketplace-addon-without-cap-nxr/marketplace-partialRelease.ini
